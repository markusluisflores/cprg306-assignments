...
export default function NewItem({ onAddItem }) {
    ...
    const handleSubmit = (event) => {
        ...
        let idGenerated = Math.random().toString(36).slice(2) + Math.random().toString(36).slice(2);
        idGenerated = idGenerated.slice(0, 18);

        console.log("new id is " + idGenerated);
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-green-400 grid grid-cols-2 gap-4 max-w-sm flex-1 mt-5 ml-10 rounded-md">
